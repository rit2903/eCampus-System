...
@Controller
@RequestMapping("/admin/adddropopen")
public class OpenAddDropController {
    ...
    @GetMapping
    public String openadddropfor(Model model){

        Long currTermId = TermRepo.findMaxTrmid();
        List<String> batches = BatchRepo.findBatchesByTrmId(currTermId);

        List<Object[]> bchSpl = OpenRegistrationService.getBatchSpl(batches,currTermId, "AddDrop");
        ...
        return "admin/addDropOpenFor";
    }

    @PostMapping("/saveadddropdate")
    public String saveAddDropDate(
        ...
        if (bchIds == null || bchIds.isEmpty()) {
            ...
            return "redirect:/admin/adddropopen";
        }
        ...
        if (startDate.isAfter(endDate) || startDate.isEqual(endDate)) {
            ...
            return "redirect:/admin/registrationopen";
        }
        ...
        Long currTermId = TermRepo.findMaxTrmid();
        OpenRegistrationService.saveRegistrationDate(startDate,endDate,currTermId,bchIds,"AddDrop");
        
        redirectAttributes.addFlashAttribute("success", "Add-Drop dates saved successfully!");
        return "redirect:/admin/adddropopen";
    }
}
