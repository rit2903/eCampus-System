...
@Controller
@RequestMapping("/admin/registrationopen")
public class OpenRegistrationController {
    ...
    public String openregistrationfor(Model model){
        ...
        List<Object[]> bchSpl = OpenRegistrationService.getBatchSpl(batches,currTermId, "Registration");
        ...
        return "admin/registrationOpenFor";
    }

    @PostMapping("/saveregistrationdate")
    public String saveRegistrationDate(
        ...
        Long currTermId = TermRepo.findMaxTrmid();
        OpenRegistrationService.saveRegistrationDate(startDate,endDate,currTermId,bchIds,"Registration");
        
        redirectAttributes.addFlashAttribute("success", "Registration dates saved successfully!");
        return "redirect:/admin/registrationopen";
    }
}
